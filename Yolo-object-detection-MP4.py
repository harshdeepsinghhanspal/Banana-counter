...
whT=320 #Weight and Height of the Target video, make sure to crop video and keep required part visible
confThreshold=0.5
...
def findObjects(outputs,img):
    ...
    for i in indices:
        ...
        cnt=0
        box=bbox[i]
        if classNames[classIds[i]].upper() == 'BANANA':
            ...
            cnt+=1
        cv2.putText(img, f' BANANA COUNT: {cnt}', (20, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (b+255, g, r-255), 2)
